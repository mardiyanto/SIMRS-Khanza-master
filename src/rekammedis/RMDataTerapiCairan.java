...
public final class RMDataTerapiCairan extends javax.swing.JDialog {
    ...
    public RMDataTerapiCairan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "HR(x/menit)","RR(x/menit)","Suhu(°C)","SpO2(%)","Subjek","Objek","Asesmen","Terapi Cairan","NIP","Nama Petugas"
        }){
        ...
        subjek_terapi.setDocument(new batasInput(Byte.MAX_VALUE).getKata(subjek_terapi));
        objek_terapi.setDocument(new batasInput(Byte.MAX_VALUE).getKata(objek_terapi));
        asesmen_terapi.setDocument(new batasInput(Byte.MAX_VALUE).getKata(asesmen_terapi));
        terapi_cairan.setDocument(new batasInput(Byte.MAX_VALUE).getKata(terapi_cairan));
    ...
    private void initComponents() {
        ...
        asesmen_terapi = new javax.swing.JTextArea();
        jScrollPane2 = new javax.swing.JScrollPane();
        terapi_cairan = new javax.swing.JTextArea();
        jScrollPane3 = new javax.swing.JScrollPane();
        subjek_terapi = new javax.swing.JTextArea();
        jScrollPane4 = new javax.swing.JScrollPane();
        objek_terapi = new javax.swing.JTextArea();
        ...
        MnCatatanObservasiRanapKebidanan.setText("Formulir Catatan Terapi Pemberian Cairan");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Catatan Terapi Pemberian Cairan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Scroll.setPreferredSize(new java.awt.Dimension(352, 200));
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1100, 325));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-12-2024" }));
        ...
        jLabel13.setText("Sabjek :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(800, 10, 50, 23);

        jLabel24.setText("Objeck:");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(810, 80, 40, 23);

        jLabel30.setText("Asesmen :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(1190, 80, 60, 23);

        jLabel31.setText("Terapi :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(1190, 10, 50, 23);

        jScrollPane1.setName("jScrollPane1"); // NOI18N

        asesmen_terapi.setColumns(20);
        asesmen_terapi.setRows(5);
        asesmen_terapi.setName("asesmen_terapi"); // NOI18N
        jScrollPane1.setViewportView(asesmen_terapi);

        FormInput.add(jScrollPane1);
        jScrollPane1.setBounds(1260, 70, 390, 50);

        jScrollPane2.setName("jScrollPane2"); // NOI18N

        terapi_cairan.setColumns(20);
        terapi_cairan.setRows(5);
        terapi_cairan.setName("terapi_cairan"); // NOI18N
        jScrollPane2.setViewportView(terapi_cairan);

        FormInput.add(jScrollPane2);
        jScrollPane2.setBounds(1260, 10, 390, 50);

        jScrollPane3.setName("jScrollPane3"); // NOI18N

        subjek_terapi.setColumns(20);
        subjek_terapi.setRows(5);
        subjek_terapi.setName("subjek_terapi"); // NOI18N
        jScrollPane3.setViewportView(subjek_terapi);

        FormInput.add(jScrollPane3);
        jScrollPane3.setBounds(860, 10, 330, 50);

        jScrollPane4.setName("jScrollPane4"); // NOI18N

        objek_terapi.setColumns(20);
        objek_terapi.setRows(5);
        objek_terapi.setName("objek_terapi"); // NOI18N
        jScrollPane4.setViewportView(objek_terapi);

        FormInput.add(jScrollPane4);
        jScrollPane4.setBounds(860, 70, 330, 50);
        ...
        ChkInput.setPreferredSize(new java.awt.Dimension(292, 20));
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Catatan Terapi Pemberian Cairan ]::");
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,terapi_cairan,BtnBatal);
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanPemberianCairanRanap.jasper","report","::[ Data Catatan Terapi Pemberian Cairan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat,catatan_terapi_ranap_cairan.gcs,"+
                    "catatan_terapi_ranap_cairan.td,catatan_terapi_ranap_cairan.hr,catatan_terapi_ranap_cairan.rr,catatan_terapi_ranap_cairan.suhu,catatan_terapi_ranap_cairan.spo2,"+
                    "catatan_terapi_ranap_cairan.subjek_terapi,catatan_terapi_ranap_cairan.objek_terapi,catatan_terapi_ranap_cairan.asesmen_terapi,catatan_terapi_ranap_cairan.terapi_cairan,"+
                    "catatan_terapi_ranap_cairan.nip,petugas.nama from catatan_terapi_ranap_cairan inner join reg_periksa on catatan_terapi_ranap_cairan.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_terapi_ranap_cairan.nip=petugas.nip where "+
                    "catatan_terapi_ranap_cairan.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat",param);
            }else{
                Valid.MyReportqry("rptDataCatatanPemberianCairanRanap.jasper","report","::[ Data Catatan Terapi Pemberian Cairan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat,catatan_terapi_ranap_cairan.gcs,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_terapi_ranap_cairan.nip=petugas.nip where "+
                    "catatan_terapi_ranap_cairan.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                    "(reg_periksa.no_rawat like '%"+TCari.getText().trim()+"%' or pasien.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    "pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or catatan_terapi_ranap_cairan.nip like '%"+TCari.getText().trim()+"%' or petugas.nama like '%"+TCari.getText().trim()+"%') "+
                    "order by catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat ",param);
            }  
        }
    ...
    private void MnCatatanObservasiRanapKebidananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanObservasiRanapKebidananActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("dpjp",dpjp);   
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptFormulirCatatanPemberianCairanRanap.jasper","report","::[ Formulir Catatan Terapi Pemberian Cairan ]::",
                    ...
                    "catatan_terapi_ranap_cairan.nip,petugas.nama from catatan_terapi_ranap_cairan inner join reg_periksa on catatan_terapi_ranap_cairan.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_terapi_ranap_cairan.nip=petugas.nip where reg_periksa.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' "+
                    "order by catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat",param);
        }
    ...
    private void SPOKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SPOKeyPressed
        Valid.pindah(evt,Suhu,subjek_terapi);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataTerapiCairan dialog = new RMDataTerapiCairan(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextArea asesmen_terapi;
    ...
    private javax.swing.JTextArea objek_terapi;
    private widget.panelisi panelGlass8;
    private widget.panelisi panelGlass9;
    private javax.swing.JTextArea subjek_terapi;
    private widget.Table tbObat;
    private javax.swing.JTextArea terapi_cairan;
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_terapi_ranap_cairan.nip=petugas.nip where "+
                    "catatan_terapi_ranap_cairan.tgl_perawatan between ? and ? order by catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.jk,pasien.tgl_lahir,catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat,catatan_terapi_ranap_cairan.gcs,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_terapi_ranap_cairan.nip=petugas.nip where "+
                    "catatan_terapi_ranap_cairan.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or catatan_terapi_ranap_cairan.nip like ? or petugas.nama like ?) "+
                    "order by catatan_terapi_ranap_cairan.tgl_perawatan,catatan_terapi_ranap_cairan.jam_rawat ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("hr"),rs.getString("rr"),rs.getString("suhu"),rs.getString("spo2"),rs.getString("subjek_terapi"),
                        rs.getString("objek_terapi"),rs.getString("asesmen_terapi"),rs.getString("terapi_cairan"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Suhu.setText("");
        SPO.setText("");
        subjek_terapi.setText("");
        objek_terapi.setText("");
        asesmen_terapi.setText("");
        terapi_cairan.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            subjek_terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            objek_terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            asesmen_terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            terapi_cairan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_terapi_ranap_cairan","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,"+
            "hr=?,rr=?,suhu=?,spo2=?,subjek_terapi=?,objek_terapi=?,asesmen_terapi=?,terapi_cairan=?,nip=?",17,new String[]{
            ...
            TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),SPO.getText(),subjek_terapi.getText(),objek_terapi.getText(),asesmen_terapi.getText(),terapi_cairan.getText(),NIP.getText(),
            ...
            tbObat.setValueAt(subjek_terapi.getText(),tbObat.getSelectedRow(),14);
            tbObat.setValueAt(objek_terapi.getText(),tbObat.getSelectedRow(),15);
            tbObat.setValueAt(asesmen_terapi.getText(),tbObat.getSelectedRow(),16);
            tbObat.setValueAt(terapi_cairan.getText(),tbObat.getSelectedRow(),17);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from catatan_terapi_ranap_cairan where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
    ...
    private void simpan() {
        if(Sequel.menyimpantf("catatan_terapi_ranap_cairan","?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",14,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),GCS.getText(),
            TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),SPO.getText(),subjek_terapi.getText(),objek_terapi.getText(),asesmen_terapi.getText(),terapi_cairan.getText(),NIP.getText()
        })==true){
            tabMode.addRow(new String[]{
                ...
                GCS.getText(),TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),SPO.getText(),subjek_terapi.getText(),objek_terapi.getText(),asesmen_terapi.getText(),
                terapi_cairan.getText(),NIP.getText(),NamaPetugas.getText()
            });
            LCount.setText(""+tabMode.getRowCount());
            emptTeks();
        } 
